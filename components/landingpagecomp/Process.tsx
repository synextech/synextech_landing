...
const Process = () => {
  ...
  return (
    <section className="h-auto w-full flex flex-col justify-center items-center bg-background gap-10 relative">
      <div
        className={cn(
      ...
      <SparklesText
        text="Your Roadmap to Digital Excellence"
        className="text-2xl md:text-4xl text-center font-bold text-foreground"
      />
          ...
          <CardContent className="px-4 py-0">
            <div className="relative w-full max-w-md overflow-hidden rounded-2xl m-0">
              <video
                ...
                playsInline
                preload="auto"
                src="https://res.cloudinary.com/dkxsadipm/video/upload/v1744209751/Untitled_video_-_Made_with_Clipchamp_zly6ly.mp4"
              />
            </div>
          </CardContent>
          <CardFooter className="p-4 border-t border-border [.border-t]:pt-4">
            <CardDescription>
              Your solution is brought to life through iterative sprints,
              combining modern frameworks with rigorous testing protocols. We
              ensure every feature meets benchmarks for security, scalability,
              and user experience.
            </CardDescription>
          </CardFooter>
        </Card>
