      ...
      <HighlightGroup className="group h-full">
        ...
        >
          <HighlighterItem className="rounded-3xl p-6">
            <CardSpotlight className="relative z-20 h-full overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-r from-slate-900 to-slate-700">
              <Particles
              ...
              <div className="flex justify-center">
                <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                  ...
                  <div className="-mt-20 flex h-full flex-col justify-center p-2 md:-mt-4 md:ml-10 md:w-[400px] z-20">
