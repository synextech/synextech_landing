...
export default function Templates() {
  ...
  // ];
  return (
    <section id="template" className="md:min-h-screen w-full flex flex-col justify-around items-center pt-10 px-5">
      <AnimatedShinyText className="inline-flex flex-col items-center text-4xl text-center md:text-6xl justify-center font-bold transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
        <span>✨ CRM</span>
        <span className="text-lg md:text-2xl py-6 text-center font-medium w-full">
          Complete School Management System
        </span>
      </AnimatedShinyText>
      <div className="mx-0 md:mx-auto mb-10 md:w-full w-80 md:max-w-7xl rounded-3xl bg-gray-950/5 p-2 ring-1 ring-neutral-700/10 dark:bg-neutral-800">
