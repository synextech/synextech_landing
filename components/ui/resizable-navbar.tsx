...
export const NavItems = ({ className }: { className?: string }) => {
  ...
  return (
    <div className={cn(" w-114 inset-x-0 mx-auto z-50", className)}>
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Contact Us">
          <div className="flex flex-col space-y-4 text-sm">
            ...
            <HoveredLink href="/team">Bot</HoveredLink>
            <HoveredLink href="/enterprise">Socials</HoveredLink>
          </div>
        </MenuItem>
      </Menu>
    </div>
  ...
  return (
    ...
    >
      <Image
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">SynexTech</span>
    </Link>
  );
};
...
export const NavbarButton = ({
  ...
  const TagComponent = Tag as React.ComponentType<any>;
